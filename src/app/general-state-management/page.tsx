...
export default function GeneralStateManagement() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 p-24">
      <h1 className="text-center text-3xl font-bold border-2 px-4 py-3 border-black bg-yellow-100">General State Management</h1>
